...
def page2():
    ...
    Label(root2, text="Flights Availability", font=("Bauhaus 93", 17), fg="White", width=46, bg="red").grid(row=1,
                                                                                                            column=0,
                                                                                                            columnspan=4)
    Label(root2, text="FROM", font=("Berlin Sans FB", 14),
          fg="Blue").grid(row=2, column=1)
    Label(root2, text="TO", font=("Berlin Sans FB", 14),
          fg="Blue").grid(row=7, column=1)
    board = StringVar()
    arr = StringVar()
    board.set("Select Current location")
    boardentry1 = OptionMenu(root2, board, "Ahmedabad",
                             "Bangalore", "Chennai", "Delhi")
    boardentry1.grid(row=2, column=2)
    arr.set("Select Destination location")
    reentry = OptionMenu(root2, arr, "Ahmedabad",
                         "Bangalore", "Chennai", "Delhi")
    ...
    def page2_1():
        ...
        def signup():
            ...
            def signin():
                ...
                def insert2():
                    ...
                    if not password1:
                        ...
                        if not data:
                            messagebox.showinfo(
                                "Error", "Invalid username or password , please run the code again")
                            exit()
                        else:
                            ...
                            def page3():
                                ...
                                Label(root8, text="Ticket Booking Passenger Name", font=(
                                    "Arial", 14), fg="Blue").grid(row=2, column=1)
                                q = name.get()
                                Label(root8, text=q, font=("Arial", 14),
                                      fg="Blue").grid(row=2, column=2)
                                Label(root8, text="Age", font=("Arial", 14),
                                      fg="Blue").grid(row=3, column=1)
                                Label(root8, text=age.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=3, column=2)
                                Label(root8, text="Gender", font=(
                                    "Arial", 14), fg="Blue").grid(row=4, column=1)
                                if a.get() == 0:
                                    Label(root8, text="Male", font=(
                                        "Arial", 14), fg="Blue").grid(row=4, column=2)
                                else:
                                    Label(root8, text="Female", font=(
                                        "Arial", 14), fg="Blue").grid(row=4, column=2)
                                Label(root8, text="Class", font=(
                                    "Arial", 14), fg="Blue").grid(row=5, column=1)
                                Label(root8, text=v.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=5, column=2)
                                Label(root8, text="Additional Passenger Details", font=("Bauhaus 93", 17), fg="Blue",
                                      width=46).grid(row=7, column=0, columnspan=4)
                                Label(root8, text="Passenger Name", font=(
                                    "Arial", 14), fg="Blue").grid(row=8, column=1)
                                Label(root8, text=name1.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=8, column=2)
                                Label(root8, text="Class", font=(
                                    "Arial", 14), fg="Blue").grid(row=9, column=1)
                                Label(root8, text=v1.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=9, column=2)
                                Label(root8, text="Passenger Name", font=("Arial", 14), fg="Blue").grid(row=10,
                                                                                                        column=1)
                                Label(root8, text=name2.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=10, column=2)
                                Label(root8, text="Class", font=(
                                    "Arial", 14), fg="Blue").grid(row=11, column=1)
                                Label(root8, text=v2.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=11, column=2)
                                Label(root8, text="Passenger Name", font=("Arial", 14), fg="Blue").grid(row=12,
                                                                                                        column=1)
                                Label(root8, text=name3.get(), font=(
                                    "Arial", 14), fg="Blue").grid(row=12, column=2)
                                Label(root8, text="Class", font=(
                                    "Arial", 14), fg="Blue").grid(row=13, column=1)
                                Label(root8, text=v3.get(), font=(
                            ...
                            Label(root6, text="Select Gender", font=("Times New Roman 93", 14), fg="blue").grid(row=5,
                                                                                                                column=1)
                            a = IntVar()
                            Radiobutton(root6, text="Male", variable=a,
                                        value=0, fg="red").grid(row=5, column=2)
                            Radiobutton(root6, text="Female", variable=a, value=1, fg="red").grid(
                                row=5, column=3)
                            Label(root6, text="Seat Class", font=("Times New Roman 93", 14), fg="blue").grid(row=6,
                                                                                                             column=1)
                            v = StringVar(root6)
                            v.set("Select class")
                            w = OptionMenu(root6, v, "First Class",
                            ...
                            v1.set("Select class")
                            w1 = OptionMenu(
                                root6, v1, "First Class", "Business Class", "Economy Class")
                            ...
                            v2.set("Select class")
                            w2 = OptionMenu(
                                root6, v2, "First Class", "Business Class", "Economy Class")
                            ...
                            v3.set("Select class")
                            w3 = OptionMenu(
                                root6, v3, "First Class", "Business Class", "Economy Class")
                ...
                v10 = StringVar()
                v20 = StringVar()
                Label(root4, text="Username", font=("Arial", 15, "bold"),
                      fg="blue").grid(row=5, column=2, pady=10)
                Label(root4, text="Password", font=("Arial", 15, "bold"),
                      fg="blue").grid(row=7, column=2, pady=10)
            ...
            Label(root5, text="Username *", font=("Arial", 14),
                  fg="blue").grid(row=2, column=0)
            Label(root5, text="Password *", font=("Arial", 14),
                  fg="blue").grid(row=3, column=0)
            Label(root5, text="Email *", font=("Arial", 14),
                  fg="blue").grid(row=4, column=0)
            Label(root5, text="Phone *", font=("Arial", 14),
            ...
            but = Button(root5, text='Submit',
                         command=insert, font='none 13 bold')
...
f1.pack()
b1 = Button(f1, fg="green", text="PROCEED TO PROJECT",
            font=("Algerian", 12), command=page2)
b1.pack()
root.mainloop()
